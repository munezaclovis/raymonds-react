...
import { toggleNotificationBar } from '../../store/ThemeSettings/Actions';
...
const Rightbar = () => {
    ...
    return (
        <>
            <div id="rightbar" className={`rightbar${settings.isNotificationbar ? " open" : ""}`}>
                <div className="body">
                    <ul className="nav nav-tabs2">
                        ...
                        <span onClick={() => setSettings(toggleNotificationBar(false))} className="search_toggle btn btn-danger"><i className="icon-close"></i></span>
                    </ul>
                    <hr />
                        ...
                        <div className="tab-pane vivify fadeIn delay-100 active" id="Chat-one">
                            <div className="chat_detail">
                                ...
                                <div className="input-group mb-0">
                                    ...
                                    <textarea rows={2} className="form-control" placeholder="Enter text here..."></textarea>
                                </div>
                            </div>
                        </div>
