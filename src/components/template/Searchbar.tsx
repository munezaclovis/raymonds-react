...
import { toggleSearchBar } from '../../store/ThemeSettings/Actions'
import { Link } from 'react-router-dom'
import { TempRoute } from '../../data/RouteNames'
...
const SearchBar = () =>
{
    ...
    return (
        <>
            <div className={ `search_div${settings.isSearchbar ? " open" : ""}` }>
                <div className="card">
                    <div className="body">
                        <form id="navbar-search" className="navbar-form search-form">
                            <div className="input-group mb-0">
                                ...
                                <div className="input-group-append">
                                    ...
                                    <span onClick={ () => setSettings(toggleSearchBar(false)) } className="search_toggle btn btn-danger"><i className="icon-close"></i></span>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ml-3">
                                            <Link to={ TempRoute } title="">South Shyanne</Link>
